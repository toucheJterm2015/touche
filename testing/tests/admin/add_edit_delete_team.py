...
class AddEditDeleteTeam(unittest.TestCase):
    ...
    def test_add_edit_delete_team(self):
        ...
        driver.find_element_by_name("organization").send_keys("org")
        driver.find_element_by_name("username").clear()
        driver.find_element_by_name("username").send_keys("team1") #the duplicate username should not be allowed but it currently gets stored anyway
        driver.find_element_by_name("password").clear()
        ...
        driver.find_element_by_name("submit").click()
        try: self.assertNotRegexpMatches(driver.find_element_by_css_selector("div.col-md-5").text, r"^[\s\S]*team 2[\s\S]*$")
        except AssertionError as e: self.verificationErrors.append(str(e))#team 2 should not be created and stored and appear on screen but it currently does, so this test fails.
        driver.find_element_by_name("team_name").clear()
        driver.find_element_by_name("team_name").send_keys("team 3")
        driver.find_element_by_name("organization").clear()
        driver.find_element_by_name("organization").send_keys("org")
        driver.find_element_by_name("username").clear()
        driver.find_element_by_name("username").send_keys("team3")
        driver.find_element_by_name("password").clear()
        driver.find_element_by_name("password").send_keys("password")
        ...
        driver.find_element_by_name("submit").click()
        try: self.assertRegexpMatches(driver.find_element_by_css_selector("div.col-md-5").text, r"^[\s\S]*team 3[\s\S]*$")
        except AssertionError as e: self.verificationErrors.append(str(e))
        ...
        driver.find_element_by_name("team_name").clear()
        driver.find_element_by_name("team_name").send_keys("team 4")
        driver.find_element_by_name("organization").clear()
        driver.find_element_by_name("organization").send_keys("org")
        driver.find_element_by_name("username").clear()
        driver.find_element_by_name("username").send_keys("team4")
        driver.find_element_by_name("password").clear()
        driver.find_element_by_name("password").send_keys("password")
        Select(driver.find_element_by_name("site_id")).select_by_visible_text("PrimarySite")
        driver.find_element_by_name("coach_name").clear()
        ...
        driver.find_element_by_name("alternate_name").send_keys("d")
        driver.find_element_by_name("email").clear()
        driver.find_element_by_name("email").send_keys("team4@team.com")
        driver.find_element_by_name("test_team").click()
        driver.find_element_by_name("submit").click()
        driver.find_element_by_name("team_name").clear()
        driver.find_element_by_name("team_name").send_keys("team 5")
        driver.find_element_by_name("organization").clear()
        driver.find_element_by_name("organization").send_keys("org")
        driver.find_element_by_name("username").clear()
        ...
        driver.find_element_by_name("alternate_name").send_keys("d")
        driver.find_element_by_name("email").clear()
        driver.find_element_by_name("email").send_keys("team5@team.com")
        driver.find_element_by_name("test_team").click()
        driver.find_element_by_name("submit").click()
        driver.find_element_by_name("team_name").clear()
        driver.find_element_by_name("team_name").send_keys("team 6")
        driver.find_element_by_name("organization").clear()
        driver.find_element_by_name("organization").send_keys("org")
        driver.find_element_by_name("username").clear()
        driver.find_element_by_name("username").send_keys("team6")
        driver.find_element_by_name("password").clear()
        driver.find_element_by_name("password").send_keys("password")
        Select(driver.find_element_by_name("site_id")).select_by_visible_text("PrimarySite")
        driver.find_element_by_name("coach_name").clear()
        ...
        driver.find_element_by_name("alternate_name").send_keys("d")
        driver.find_element_by_name("email").clear()
        driver.find_element_by_name("email").send_keys("team6@team.com")
        driver.find_element_by_name("submit").click()
